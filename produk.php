          ...
          <div class="navbar-font flex items-center space-x-6">
            ...
            <div class="flex items-center space-x-4">
              <div class="relative inline-block">
                <button onclick="toggleCart()" class="relative hover:text-gray-300">
    ...
    <main class="container mx-auto px-6 py-12">
      ...
      >
        ...
        <div class="product-item pempek mx-4">
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <div class="relative">
              <img src="https://i.pinimg.com/736x/d3/38/97/d33897a61ff84685ae6885e67054606d.jpg" alt="Pempek Pistel" class="w-full h-48 object-cover object-center"/>
            </div>
            <div class="p-4">
              <h3 class="text-lg font-medium mb-2">Paket Pempek Ikan</h3>
              <div class="flex items-center justify-between mb-3">
                <span class="text-orange-500 font-medium">Rp 14.000</span>
                <div class="flex items-center space-x-2">
                  <button class="quantity-btn minus bg-gray-200 px-2 py-1 rounded" onclick="updateQuantity(this, -1)">-</button>
                  <input type="number" class="quantity-input w-12 text-center border rounded" value="1" min="1" readonly>
                  <button class="quantity-btn plus bg-gray-200 px-2 py-1 rounded" onclick="updateQuantity(this, 1)">+</button>
        ...
        <div class="product-item pempek mx-4">
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <div class="relative">
              <img src="https://img.freepik.com/free-photo/deep-fried-fhicken-roll-white-wooden-surface_1150-43596.jpg?t=st=1732419186~exp=1732422786~hmac=837a0488ecdd6444f690f403e02076000a795810daba865be601e3b708672be1&w=1060" alt="Pempek Keriting" class="w-full h-48 object-cover object-center"/>
            </div>
            <div class="p-4">
              <h3 class="text-lg font-medium mb-2">Paket Pempek Dose</h3>
              <div class="flex items-center justify-between mb-3">
                <span class="text-orange-500 font-medium">Rp 13.000</span>
                <div class="flex items-center space-x-2">
                  <button class="quantity-btn minus bg-gray-200 px-2 py-1 rounded" onclick="updateQuantity(this, -1)">-</button>
        ...
        <div class="product-item pempek mx-4">
          <div class="bg-white rounded-lg overflow-hidden shadow-md hover:shadow-lg transition-shadow">
            <div class="relative">
              <img src="https://img.freepik.com/free-photo/high-angle-plate-with-pakistani-food_23-2148825158.jpg?t=st=1732418623~exp=1732422223~hmac=c469a2922aafdba62ad8e9292cd947c6e8c89d3867c9bf06028a523071cf02ec&w=740" alt="Pempek Telur Kecil" class="w-full h-48 object-cover object-center"/>
            </div>
            <div class="p-4">
              <h3 class="text-lg font-medium mb-2">Paket Pempek Pastel</h3>
              <div class="flex items-center justify-between mb-3">
                <span class="text-orange-500 font-medium">Rp 12.000</span>
                <div class="flex items-center space-x-2">
                  <button class="quantity-btn minus bg-gray-200 px-2 py-1 rounded" onclick="updateQuantity(this, -1)">-</button>
